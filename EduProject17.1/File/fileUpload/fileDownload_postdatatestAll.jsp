...
<%
	...
	System.out.println("getFolderName : " + getFolderName);
	System.out.println("getNameList : " + getNameList);
	...
	try
	{
		...
		for( int i = 0; i < arrNameList.length; i++ ){
			...
			filePath = contextRealPath + getFolderName + File.separator + filename;
