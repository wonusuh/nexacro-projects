...
<%
	...
	String filePath = contextRealPath + getFolderName + File.separator + filename; 
	...
	if(fis.exists())
	{
		try
		{
			...
			response.setHeader("Content-Disposition", "attachment; filename=" + URLEncoder.encode(filename, "utf-8") + ";"); //수정일 : 2019.09.06 : 파일다운로드 시 한글깨짐 처리
			out.clear();
